...
import ux from "@/assets/images/UiUx.png";
  ...
  return (
    <div className="sm:flex-row flex mt-10 w-full justify-center gap-4">
      <div className="flex flex-col sm:flex-row mt-10 w-full justify-center gap-4 lg:gap-20 lg:p-4">
        ...
        >
          <h1 className="font-semibold text-2xl lg:text-[32px] text-center lg:pb-4">UI/UX Design</h1>

          <ul className="list-disc pl-5 space-y-2 text-sm lg:space-y-4 tracking-wide lg:text-[16px]">
            <li>Offering professional UI/UX design services</li>
            <li>Specializing in intuitive, visually appealing designs prioritizing user needs</li>
            <li>Certified with hands-on experience in front-end coding</li>
            <li>Bridging the gap between design and development for seamless integration</li>
            <li>Expertise in designing sleek web and app interfaces</li>
            <li>Focus on user-friendly and efficient designs</li>
          </ul>

          <div className="absolute bg-[#00D7B7] w-[40%] h-[8px] rounded-full top-[-20.5px] shadow-[0_0_16px_#00D7B7]"></div>
        </div>
